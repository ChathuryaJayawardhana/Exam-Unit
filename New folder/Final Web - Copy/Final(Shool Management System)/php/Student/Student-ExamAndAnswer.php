...
<body>
    ...
    <div class="heading">
            <h1> Sinhala Exam And Result Sheets </h1>
     ...
     <div class="wrapper2" style="width: 400px">
     ...
     <div class="wrapper3" style="width: 400px">
        ...
        <div class="file_upload_list">
         ...
         <div class="wrapper4" style="width: 400px">
        <div class="title"> Result Sheets </div>
        <div class="file_upload_list">
            <ul>
                <li>
                    <div class="file_item">
